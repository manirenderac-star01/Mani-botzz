...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/manibot375/Mani-bot/tree/main';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/mneeys.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || '𝐌𝐀𝐍𝐈_𝐌𝐃',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
